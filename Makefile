...
SOURCES = main.c system.c usbd_conf.c usbd_cdc_if.c usb_device.c usbd_desc.c interrupts.c system_stm32f0xx.c can.c led.c error.c printf.c cobs.c ringbuf.c okcan.c usb_cdc.c lock.c
